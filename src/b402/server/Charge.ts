import { Errors, evm, Method, Receipt } from 'mppx'
...
export declare namespace charge {
  ...
  export type Parameters = {
    ...
    readonly client: B402FacilitatorClient
...
function normalizeTransferMethods(
...
async function resolveProviderSnapshot(parameters: {
  cache: B402SupportedCache
  name: string
  network: string
  transferMethod: B402ChargeTransferMethod
  version: string
}): Promise<{ signerAddress: `0x${string}`; spenderAddress?: `0x${string}` | undefined }> {
...
async function reconstructPayment(parameters: {
  credential: {
    readonly challenge: {
...
function assertAddressEqual(actual: string, expected: string, reason: string): void {
