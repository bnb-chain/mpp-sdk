import { type PaymentRequirements } from '@bnb-chain/mpp/b402'
...
export interface ExecState {
  ...
  /** x402 tab only — the chosen `accepts[]` entry from the 402 JSON body
   *  (the standalone-wire counterpart of `challenge`). */
  x402Offer: PaymentRequirements | null
