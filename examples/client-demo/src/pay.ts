...
// EIP-3009 needs the token's EIP-712 domain (a property of the token CONTRACT,
// not on the wire). The probed anchors live in a shared module so this low-level
// demo and the high-level `pay-policy.ts` cover the same tokens — see README "Tokens".
