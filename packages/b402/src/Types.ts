 ...
 *
 * B402 exposes an **x402 v2** facilitator API. These types model the provider
 * request/response Seam used by direct x402 integrations and protocol adapters.
 * This module models the supported `exact` scheme with the `eip3009` OR
 * `permit2-exact` asset-transfer method —
 ...
 * Seam and do not leak into these payment types.
 */
...
export type AssetTransferMethod = 'eip3009' | 'permit2-exact'
